 ...
 * 邮箱：454366460@qq.com
 */
public class HomeRecycleView1 implements RecyclerArrayAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static HomeRecycleView1 Builder() {
        return new HomeRecycleView1();
    }
    ...
    public void onLoadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                currentpage++;
                getData(false, currentpage, JsoupApi.typeUpdate);
            }
        });
    }
    ...
    public void onRefresh() {
        ...
        handler.post(new Runnable() {
            @Override
            public void run() {
                getData(true, 1, JsoupApi.typeUpdate);
            }
        });
    }
