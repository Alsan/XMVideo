 ...
 * 邮箱：454366460@qq.com
 */
public class HomeRecycleView4 implements RecyclerArrayAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {

    public static final String type = JsoupApi.typeCartoon;
    ...
    public static HomeRecycleView4 Builder() {
        return new HomeRecycleView4();
    }
