 ...
 * 邮箱：454366460@qq.com
 */
public class HomeRecycleView3 implements RecyclerArrayAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {

    public static final String type = JsoupApi.typeTv;
    ...
    public static HomeRecycleView3 Builder() {
        return new HomeRecycleView3();
    }
