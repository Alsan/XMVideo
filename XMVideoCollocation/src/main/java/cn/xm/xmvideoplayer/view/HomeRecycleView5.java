 ...
 * 邮箱：454366460@qq.com
 */
public class HomeRecycleView5 implements RecyclerArrayAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {

    public static final String type = JsoupApi.typeVariety;
    ...
    public static HomeRecycleView5 Builder() {
        return new HomeRecycleView5();
    }
